...
- **Venue:** ACM MM 2021
- **Paper:** [https://arxiv.org/abs/2107.02963](https://arxiv.org/abs/2107.02963)
- **Code:** [official code](https://github.com/chenminghao3/DDOD)
...
Disentangles classification and localization optimization in dense object detectors.

## 背景与问题 / Background and Problem

This work is cataloged under **General Object Detection** for the `one_stage` detector family. Its recorded task scope is:
...
- **Code availability:** https://github.com/chenminghao3/DDOD
...
- Evaluate classification and regression improvements with separate error diagnostics.
