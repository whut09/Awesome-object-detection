...
- **Venue:** CVPR 2021
- **Paper:** [https://arxiv.org/abs/2103.14259](https://arxiv.org/abs/2103.14259)
- **Code:** [official code](https://github.com/Megvii-BaseDetection/OTA)
- **Institution:** Megvii
...
Formulates label assignment as an optimal transport problem with global matching costs.
...
- `optimal_transport_assigner`
- `dynamic_positive_selection`
...
- **Code availability:** https://github.com/Megvii-BaseDetection/OTA
...
- Use assignment-cost diagnostics before tuning loss weights independently.
