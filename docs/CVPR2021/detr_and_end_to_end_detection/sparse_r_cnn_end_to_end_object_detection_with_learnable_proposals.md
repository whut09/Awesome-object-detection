...
- **Code:** [official code](https://github.com/PeizeSun/SparseR-CNN)
- **Institution:** HKU / ByteDance
- **Category:** DETR and End-to-End Detection
- **Detector family:** `sparse_rcnn`
- **Applicability:** `separate_detector_family`

## 摘要 / Abstract

Uses a fixed sparse set of learned proposal boxes and proposal features for end-to-end detection.

## 背景与问题 / Background and Problem

This work is cataloged under **DETR and End-to-End Detection** for the `sparse_rcnn` detector family. Its recorded task scope is:
...
- **Code availability:** https://github.com/PeizeSun/SparseR-CNN
...
- Use as a sparse-proposal baseline when dense anchors create duplicate predictions.
