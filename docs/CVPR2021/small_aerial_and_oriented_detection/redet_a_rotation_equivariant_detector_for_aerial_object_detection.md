...
- **Venue:** CVPR 2021
- **Paper:** [https://arxiv.org/abs/2103.07733](https://arxiv.org/abs/2103.07733)
- **Code:** [official code](https://github.com/csuhan/ReDet)
- **Institution:** Wuhan University
- **Category:** Small, Aerial, and Oriented Detection
- **Detector family:** `two_stage_oriented`
- **Applicability:** `recipe_idea_only`

## 摘要 / Abstract

Introduces rotation-equivariant features and rotation-invariant RoI alignment for aerial detection.

## 背景与问题 / Background and Problem

This work is cataloged under **Small, Aerial, and Oriented Detection** for the `two_stage_oriented` detector family. Its recorded task scope is:
...
- `rotation_equivariant_backbone`
- `rotation_invariant_roi_align`
...
- **Code availability:** https://github.com/csuhan/ReDet
...
- Compare equivariant features against rotation-only augmentation.
