...
- **Venue:** CVPR 2022
- **Paper:** [https://openaccess.thecvf.com/content/CVPR2022/html/Hong_Dynamic_Sparse_R-CNN_CVPR_2022_paper.html](https://openaccess.thecvf.com/content/CVPR2022/html/Hong_Dynamic_Sparse_R-CNN_CVPR_2022_paper.html)
...
CVPR 2022 paper on Dynamic Sparse R-CNN.

## 背景与问题 / Background and Problem

This work is cataloged under **General Object Detection** for the `two_stage` detector family. Its recorded task scope is:
