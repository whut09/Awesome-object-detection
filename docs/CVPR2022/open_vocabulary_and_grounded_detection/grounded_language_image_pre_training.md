...
- **Code:** [official code](https://github.com/microsoft/GLIP)
- **Institution:** Microsoft
- **Category:** Open-Vocabulary and Grounded Detection
- **Detector family:** `grounded_detector`
- **Applicability:** `separate_detector_family`

## 摘要 / Abstract

Unifies object detection and phrase grounding through language-image pre-training.

## 背景与问题 / Background and Problem

This work is cataloged under **Open-Vocabulary and Grounded Detection** for the `grounded_detector` detector family. Its recorded task scope is:
...
- **Code availability:** https://github.com/microsoft/GLIP
...
- Use text-conditioned detection only when category expansion justifies its cost.
