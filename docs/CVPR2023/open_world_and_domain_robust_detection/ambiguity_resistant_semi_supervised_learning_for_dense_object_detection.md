...
- **Venue:** CVPR 2023
- **Paper:** [https://openaccess.thecvf.com/content/CVPR2023/html/Liu_Ambiguity-Resistant_Semi-Supervised_Learning_for_Dense_Object_Detection_CVPR_2023_paper.html](https://openaccess.thecvf.com/content/CVPR2023/html/Liu_Ambiguity-Resistant_Semi-Supervised_Learning_for_Dense_Object_Detection_CVPR_2023_paper.html)
...
CVPR 2023 paper on Ambiguity-Resistant Semi-Supervised Learning for Dense Object Detection.

## 背景与问题 / Background and Problem

This work is cataloged under **Open-World and Domain-Robust Detection** for the `one_stage` detector family. Its recorded task scope is:
