...
- **Venue:** CVPR 2024
- **Paper:** [https://openaccess.thecvf.com/content/CVPR2024/html/Liu_Unbiased_Faster_R-CNN_for_Single-source_Domain_Generalized_Object_Detection_CVPR_2024_paper.html](https://openaccess.thecvf.com/content/CVPR2024/html/Liu_Unbiased_Faster_R-CNN_for_Single-source_Domain_Generalized_Object_Detection_CVPR_2024_paper.html)
- **Code:** Not recorded in the catalog.
- **Institution:** See paper
- **Category:** Open-World and Domain-Robust Detection
- **Detector family:** `two_stage`
- **Applicability:** `recipe_idea_only`

## 摘要 / Abstract

CVPR 2024 paper on Unbiased Faster R-CNN for Single-source Domain Generalized Object Detection.

## 背景与问题 / Background and Problem

This work is cataloged under **Open-World and Domain-Robust Detection** for the `two_stage` detector family. Its recorded task scope is:
