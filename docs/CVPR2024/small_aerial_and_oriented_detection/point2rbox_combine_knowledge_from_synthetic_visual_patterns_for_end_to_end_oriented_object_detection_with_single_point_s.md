...
- **Venue:** CVPR 2024
- **Paper:** [https://openaccess.thecvf.com/content/CVPR2024/html/Yu_Point2RBox_Combine_Knowledge_from_Synthetic_Visual_Patterns_for_End-to-end_Oriented_CVPR_2024_paper.html](https://openaccess.thecvf.com/content/CVPR2024/html/Yu_Point2RBox_Combine_Knowledge_from_Synthetic_Visual_Patterns_for_End-to-end_Oriented_CVPR_2024_paper.html)
...
CVPR 2024 paper on Point2RBox: Combine Knowledge from Synthetic Visual Patterns for End-to-end Oriented Object Detection with Single Point Supervision.

## 背景与问题 / Background and Problem

This work is cataloged under **Small, Aerial, and Oriented Detection** for the `detr` detector family. Its recorded task scope is:
