...
- **Code:** [official code](https://github.com/lyuwenyu/RT-DETR)
- **Institution:** Baidu
...
Introduces RT-DETR with an efficient hybrid encoder and uncertainty-minimal query selection.
...
- `hybrid_encoder`
- `uncertainty_minimal_query_selection`
- `nms_free_detection`
...
- **Code availability:** https://github.com/lyuwenyu/RT-DETR
...
- Benchmark end-to-end latency, including NMS, against YOLO.
