...
- **Venue:** CVPR 2025
- **Paper:** [https://arxiv.org/abs/2503.07465](https://arxiv.org/abs/2503.07465)
- **Code:** [official code](https://github.com/THU-MIG/yoloe)
...
Extends YOLO to text, visual, and prompt-free open-vocabulary detection.
...
- **Code availability:** https://github.com/THU-MIG/yoloe
...
- Choose prompt mode based on vocabulary stability.
- Evaluate reparameterized closed-vocabulary latency separately.
