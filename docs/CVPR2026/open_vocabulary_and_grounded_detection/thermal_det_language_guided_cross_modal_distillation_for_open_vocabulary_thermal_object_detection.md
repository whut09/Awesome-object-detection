...
- **Venue:** CVPR 2026
- **Paper:** [https://openaccess.thecvf.com/content/CVPR2026/html/Ranasinghe_Thermal-Det_Language-Guided_Cross-Modal_Distillation_for_Open-Vocabulary_Thermal_Object_Detection_CVPR_2026_paper.html](https://openaccess.thecvf.com/content/CVPR2026/html/Ranasinghe_Thermal-Det_Language-Guided_Cross-Modal_Distillation_for_Open-Vocabulary_Thermal_Object_Detection_CVPR_2026_paper.html)
...
Recent object-detection paper indexed from the corresponding conference object-detection collection.

## 背景与问题 / Background and Problem

This work is cataloged under **Open-Vocabulary and Grounded Detection** for the `other` detector family. Its recorded task scope is:
...
- The paper is indexed as a `insufficient_information` for detector research and harness design.
...
- Review the official paper and reproduce the claimed improvement before adoption.
