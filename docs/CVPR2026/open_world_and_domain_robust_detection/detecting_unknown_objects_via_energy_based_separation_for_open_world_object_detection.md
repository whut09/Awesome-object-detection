...
- **Venue:** CVPR 2026
- **Paper:** [https://arxiv.org/abs/2603.29954](https://arxiv.org/abs/2603.29954)
- **Code:** Not recorded in the catalog.
- **Institution:** Korea Advanced Institute of Science and Technology
- **Category:** Open-World and Domain-Robust Detection
- **Detector family:** `open_world_detector`
- **Applicability:** `recipe_idea_only`

## 摘要 / Abstract

Uses ETF-based unknown separation and energy-based known distinction to improve unknown discovery while reducing forgetting.

## 背景与问题 / Background and Problem

This work is cataloged under **Open-World and Domain-Robust Detection** for the `open_world_detector` detector family. Its recorded task scope is:
...
- Report known-class retention and unknown recall separately under incremental updates.
