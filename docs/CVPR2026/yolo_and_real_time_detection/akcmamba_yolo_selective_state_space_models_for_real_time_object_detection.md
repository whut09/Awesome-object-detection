...
- **Venue:** CVPR 2026
- **Paper:** [https://openaccess.thecvf.com/content/CVPR2026/html/Chen_AKCMamba-YOLO_Selective_State_Space_Models_For_Real-Time_Object_Detection_CVPR_2026_paper.html](https://openaccess.thecvf.com/content/CVPR2026/html/Chen_AKCMamba-YOLO_Selective_State_Space_Models_For_Real-Time_Object_Detection_CVPR_2026_paper.html)
- **Code:** Not recorded in the catalog.
- **Institution:** See paper
- **Category:** YOLO and Real-Time Detection
...
This work is cataloged under **YOLO and Real-Time Detection** for the `yolo` detector family. Its recorded task scope is:
