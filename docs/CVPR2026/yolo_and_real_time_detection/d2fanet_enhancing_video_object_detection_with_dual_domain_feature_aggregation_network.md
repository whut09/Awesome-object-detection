...
- **Venue:** CVPR 2026
- **Paper:** [https://openaccess.thecvf.com/content/CVPR2026/html/Qi_D2FANet_Enhancing_Video_Object_Detection_with_Dual-Domain_Feature_Aggregation_Network_CVPR_2026_paper.html](https://openaccess.thecvf.com/content/CVPR2026/html/Qi_D2FANet_Enhancing_Video_Object_Detection_with_Dual-Domain_Feature_Aggregation_Network_CVPR_2026_paper.html)
...
CVPR 2026 paper on D2FANet: Enhancing Video Object Detection with Dual-Domain Feature Aggregation Network.

## 背景与问题 / Background and Problem

This work is cataloged under **YOLO and Real-Time Detection** for the `other` detector family. Its recorded task scope is:
...
- Measure exported end-to-end latency together with accuracy on the target hardware.
