...
- **Venue:** ECCV 2022
- **Paper:** [https://arxiv.org/abs/2205.06230](https://arxiv.org/abs/2205.06230)
- **Code:** [official code](https://github.com/google-research/scenic/tree/main/scenic/projects/owl_vit)
- **Institution:** Google Research
- **Category:** Open-Vocabulary and Grounded Detection
- **Detector family:** `owl_vit`
- **Applicability:** `separate_detector_family`

## 摘要 / Abstract

Adapts contrastive vision-language pretraining to open-vocabulary detection with text queries.

## 背景与问题 / Background and Problem

This work is cataloged under **Open-Vocabulary and Grounded Detection** for the `owl_vit` detector family. Its recorded task scope is:
...
- **Code availability:** https://github.com/google-research/scenic/tree/main/scenic/projects/owl_vit
...
- Use OWL-ViT as a zero-shot baseline before training a custom head.
