# Bridging the Gap between Classification and Localization for Better Feature Alignment
...
- **Venue:** ICCV 2023
- **Paper:** [https://openaccess.thecvf.com/content/ICCV2023/html/Yang_Bridging_the_Gap_between_Classification_and_Localization_for_Better_Feature_Alignment_ICCV_2023_paper.html](https://openaccess.thecvf.com/content/ICCV2023/html/Yang_Bridging_the_Gap_between_Classification_and_Localization_for_Better_Feature_Alignment_ICCV_2023_paper.html)
- **Code:** [official code](https://github.com/TinyTigerPan/BCKD)
- **Institution:** See paper
- **Category:** Assignment, Loss, and Training
- **Detector family:** `one_stage`
- **Applicability:** `direct_adapter_candidate`

## 摘要 / Abstract

Aligns classification and localization representations to reduce cross-task inconsistency in dense detection.

## 背景与问题 / Background and Problem

This work is cataloged under **Assignment, Loss, and Training** for the `one_stage` detector family. Its recorded task scope is:
...
- `feature_alignment`
- `classification_localization_consistency`
...
- **Code availability:** https://github.com/TinyTigerPan/BCKD
...
- Inspect whether classification confidence and localization quality become better correlated.
