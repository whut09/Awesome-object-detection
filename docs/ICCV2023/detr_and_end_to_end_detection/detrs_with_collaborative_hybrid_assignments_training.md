...
- **Venue:** ICCV 2023
- **Paper:** [https://arxiv.org/abs/2211.12860](https://arxiv.org/abs/2211.12860)
- **Code:** [official code](https://github.com/Sense-X/Co-DETR)
...
Uses auxiliary heads with diverse assignment strategies to improve encoder feature learning.
...
- `auxiliary_detection_heads`
- `positive_query_mining`
...
- **Code availability:** https://github.com/Sense-X/Co-DETR
...
- Try diverse auxiliary assigners only after a clean baseline is established.
