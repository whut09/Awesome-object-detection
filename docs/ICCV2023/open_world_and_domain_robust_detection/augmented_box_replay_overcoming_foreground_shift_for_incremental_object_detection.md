...
Replays augmented object boxes to mitigate foreground shift during incremental detector updates.
...
- Measure old-class retention and new-class learning separately after each increment.
