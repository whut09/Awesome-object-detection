...
- **Venue:** ICIP 2022
- **Paper:** [https://arxiv.org/abs/2202.06934](https://arxiv.org/abs/2202.06934)
- **Code:** [official code](https://github.com/obss/sahi)
- **Institution:** OBSS
- **Category:** Small, Aerial, and Oriented Detection
- **Detector family:** `model_agnostic`
- **Applicability:** `direct_adapter_candidate`

## 摘要 / Abstract

Uses sliced inference and fine-tuning to improve small-object recall in high-resolution images.

## 背景与问题 / Background and Problem

This work is cataloged under **Small, Aerial, and Oriented Detection** for the `model_agnostic` detector family. Its recorded task scope is:
...
- **Code availability:** https://github.com/obss/sahi
...
- Try SAHI before retraining when misses correlate with tiny pixel area.
- Track duplicate rate and latency with AP_small.
