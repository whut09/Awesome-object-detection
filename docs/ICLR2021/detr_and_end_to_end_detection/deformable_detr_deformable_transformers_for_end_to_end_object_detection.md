...
- **Venue:** ICLR 2021
- **Paper:** [https://arxiv.org/abs/2010.04159](https://arxiv.org/abs/2010.04159)
- **Code:** [official code](https://github.com/fundamentalvision/Deformable-DETR)
- **Institution:** SenseTime / USTC
...
Introduces multi-scale deformable attention to accelerate DETR convergence and improve small-object detection.
...
- **Code availability:** https://github.com/fundamentalvision/Deformable-DETR
...
- Test deformable multi-scale attention when small-object recall is weak.
- Compare convergence speed under the same epoch budget.
