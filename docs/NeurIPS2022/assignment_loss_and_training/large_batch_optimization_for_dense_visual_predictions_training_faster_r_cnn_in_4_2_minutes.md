...
- **Venue:** NeurIPS 2022
- **Paper:** [https://proceedings.neurips.cc/paper_files/paper/2022/hash/76bea0a1cf7bf9b78f842009f6de15a1-Abstract-Conference.html](https://proceedings.neurips.cc/paper_files/paper/2022/hash/76bea0a1cf7bf9b78f842009f6de15a1-Abstract-Conference.html)
...
NeurIPS 2022 paper on Large-batch Optimization for Dense Visual Predictions: Training Faster R-CNN in 4.2 Minutes.

## 背景与问题 / Background and Problem

This work is cataloged under **Assignment, Loss, and Training** for the `two_stage` detector family. Its recorded task scope is:
