...
- **Venue:** NeurIPS 2025
- **Paper:** [https://arxiv.org/abs/2502.12524](https://arxiv.org/abs/2502.12524)
- **Code:** [official code](https://github.com/sunsmarterjie/yolov12)
- **Institution:** University at Buffalo / UCAS
...
Builds an attention-centric YOLO with area attention and efficient layer aggregation.
...
- `area_attention`
- `residual_efficient_layer_aggregation`
...
- **Code availability:** https://github.com/sunsmarterjie/yolov12
...
- Gate attention blocks by measured latency and memory, not FLOPs alone.
