...
- **Venue:** arXiv 2022
- **Paper:** [https://arxiv.org/abs/2211.15444](https://arxiv.org/abs/2211.15444)
- **Code:** [official code](https://github.com/tinyvision/DAMO-YOLO)
...
Presents a deployment-oriented real-time detector with neural architecture search, efficient heads, and distillation.
...
- **Code availability:** https://github.com/tinyvision/DAMO-YOLO
...
- Validate the full latency stack including preprocessing, postprocessing, and export backend.
