...
- **Venue:** arXiv 2022
- **Paper:** [https://arxiv.org/abs/2212.07784](https://arxiv.org/abs/2212.07784)
- **Code:** [official code](https://github.com/open-mmlab/mmyolo)
- **Institution:** OpenMMLab
...
Provides an empirical design study of backbone, neck, head, assignment, and augmentation.

## 背景与问题 / Background and Problem

This work is cataloged under **YOLO and Real-Time Detection** for the `one_stage` detector family. Its recorded task scope is:
...
- **Code availability:** https://github.com/open-mmlab/mmyolo
...
- Use RTMDet as a checklist for balanced backbone-neck-head scaling.
