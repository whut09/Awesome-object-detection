...
- **Code:** [official code](https://github.com/IDEA-Research/GroundingDINO)
- **Institution:** IDEA Research
- **Category:** Open-Vocabulary and Grounded Detection
- **Detector family:** `grounding_dino`
- **Applicability:** `separate_detector_family`

## 摘要 / Abstract

Combines DINO with grounded language pretraining for text-prompted open-set detection.

## 背景与问题 / Background and Problem

This work is cataloged under **Open-Vocabulary and Grounded Detection** for the `grounding_dino` detector family. Its recorded task scope is:
...
- `language_guided_query_selection`
- `cross_modal_fusion`
...
- **Code availability:** https://github.com/IDEA-Research/GroundingDINO
...
- Use for annotation bootstrapping, then verify pseudo-label precision per class.
