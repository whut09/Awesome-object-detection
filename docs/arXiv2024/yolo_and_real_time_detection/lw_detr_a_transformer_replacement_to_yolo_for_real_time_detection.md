...
- **Venue:** arXiv 2024
- **Paper:** [https://arxiv.org/abs/2406.03459](https://arxiv.org/abs/2406.03459)
- **Code:** [official code](https://github.com/Atten4Vis/LW-DETR)
...
Designs a lightweight DETR with efficient projections and a shallow decoder.

## 背景与问题 / Background and Problem

This work is cataloged under **YOLO and Real-Time Detection** for the `detr` detector family. Its recorded task scope is:
...
- **Code availability:** https://github.com/Atten4Vis/LW-DETR
...
- Use as a matched real-time transformer baseline against YOLO variants.
