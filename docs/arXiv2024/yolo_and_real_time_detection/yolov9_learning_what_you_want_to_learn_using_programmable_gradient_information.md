...
- **Code:** [official code](https://github.com/WongKinYiu/yolov9)
...
Introduces programmable gradient information and GELAN for efficient detection learning.
...
- `programmable_gradient_information`
- `gelan`
- `auxiliary_reversible_branch`
...
- **Code availability:** https://github.com/WongKinYiu/yolov9
...
- Require matched multi-seed evidence for gradient-path changes.
