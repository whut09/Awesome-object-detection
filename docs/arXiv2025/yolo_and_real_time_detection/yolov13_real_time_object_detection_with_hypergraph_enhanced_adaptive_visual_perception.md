...
- **Venue:** arXiv 2025
- **Paper:** [https://arxiv.org/abs/2506.17733](https://arxiv.org/abs/2506.17733)
- **Code:** [official code](https://github.com/iMoonLab/yolov13)
...
Introduces HyperACE and FullPAD to model high-order cross-location and cross-scale correlations for lightweight real-time detection.
...
- **Code availability:** https://github.com/iMoonLab/yolov13
...
- Compare high-order feature aggregation against standard pairwise attention at matched latency.
