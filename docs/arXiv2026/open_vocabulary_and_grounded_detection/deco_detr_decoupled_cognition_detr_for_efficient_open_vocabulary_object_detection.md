...
- **Venue:** arXiv 2026
- **Paper:** [https://arxiv.org/abs/2604.02753](https://arxiv.org/abs/2604.02753)
...
Separates semantic cognition from localization using reusable semantic prototypes and decoupled training.
...
- `semantic_prototypes`
- `decoupled_training`
- `vision_centric_open_vocabulary`
...
- Measure text-encoder removal and zero-shot accuracy as separate trade-offs.
