...
- **Venue:** arXiv 2026
- **Paper:** [https://arxiv.org/abs/2603.07022](https://arxiv.org/abs/2603.07022)
- **Code:** [official code](https://github.com/wleilei/OV-DEIM)
...
Builds an efficient open-vocabulary detector on DEIMv2 and introduces GridSynthetic augmentation for rare categories.
...
- **Code availability:** https://github.com/wleilei/OV-DEIM
...
- Check rare-category AP and inference cost when testing grid composition.
