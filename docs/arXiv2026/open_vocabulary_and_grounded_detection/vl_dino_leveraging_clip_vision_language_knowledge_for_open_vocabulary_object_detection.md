# VL-DINO: Leveraging CLIP Vision-Language Knowledge for Open-Vocabulary Object Detection
...
- **Venue:** arXiv 2026
- **Paper:** [https://arxiv.org/abs/2606.11546](https://arxiv.org/abs/2606.11546)
...
Enhances DINO with CLIP visual-language features, query-guided positive samples, and object-region semantic alignment.
...
- `clip_distillation`
- `positive_sample_construction`
- `region_text_alignment`
...
- Use zero-shot and base-class AP together when evaluating language priors.
