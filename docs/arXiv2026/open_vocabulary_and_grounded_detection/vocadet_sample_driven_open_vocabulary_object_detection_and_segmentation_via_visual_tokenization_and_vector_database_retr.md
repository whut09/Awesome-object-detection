...
- **Venue:** arXiv 2026
- **Paper:** [https://arxiv.org/abs/2607.08541](https://arxiv.org/abs/2607.08541)
- **Code:** Not recorded in the catalog.
- **Institution:** University of Technology Sydney
- **Category:** Open-Vocabulary and Grounded Detection
- **Detector family:** `retrieval_detector`
- **Applicability:** `separate_detector_family`

## 摘要 / Abstract

Builds expandable visual memories from positive and negative samples for training-free open-vocabulary detection and segmentation.

## 背景与问题 / Background and Problem

This work is cataloged under **Open-Vocabulary and Grounded Detection** for the `retrieval_detector` detector family. Its recorded task scope is:
...
- `visual_tokenization`
- `vector_database_retrieval`
- `sample_driven_recognition`
...
- Use sample-driven retrieval when categories change more often than model retraining is possible.
