...
- **Venue:** arXiv 2026
- **Paper:** [https://arxiv.org/abs/2607.08004](https://arxiv.org/abs/2607.08004)
- **Code:** Not recorded in the catalog.
- **Institution:** University of California, Santa Cruz
- **Category:** Small, Aerial, and Oriented Detection
- **Detector family:** `oriented_detr`
- **Applicability:** `separate_detector_family`

## 摘要 / Abstract

Uses text prompts and prompt-modulated content queries for oriented object detection in aerial imagery.

## 背景与问题 / Background and Problem

This work is cataloged under **Small, Aerial, and Oriented Detection** for the `oriented_detr` detector family. Its recorded task scope is:
...
- Evaluate prompt-conditioned oriented detection separately on dense and sparse scenes.
