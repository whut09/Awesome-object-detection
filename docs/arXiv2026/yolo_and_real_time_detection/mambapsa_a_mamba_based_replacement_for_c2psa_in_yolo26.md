...
- **Venue:** arXiv 2026
- **Paper:** [https://arxiv.org/abs/2607.12681](https://arxiv.org/abs/2607.12681)
...
Replaces an attention block in YOLO26 with a lightweight Mamba-based module and studies the efficiency-accuracy trade-off.
...
- Compare CPU throughput, memory, and accuracy before adopting state-space blocks.
