...
- **Venue:** arXiv 2026
- **Paper:** [https://arxiv.org/abs/2606.03748](https://arxiv.org/abs/2606.03748)
- **Code:** [official code](https://github.com/ultralytics/ultralytics)
...
Presents an end-to-end YOLO model optimized for edge deployment with simplified inference and broad vision-task support.
...
- **Code availability:** https://github.com/ultralytics/ultralytics
...
- Benchmark exported edge runtimes and end-to-end postprocessing cost rather than framework throughput alone.
